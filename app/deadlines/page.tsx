  ...
  return (
    <>
      <PageHeader
        ...
        lead="Почти все окна приходятся на ноябрь–апрель. Если наложить их друг на друга, видно, что документы разумнее собирать до зимы: иначе апостиль приходится делать в разгар очередей."
      />
